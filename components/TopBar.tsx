...
export default async function TopBar() {
  ...
  return (
    <div className="sticky top-0 z-30">
      <div className="max-w-6xl mx-auto px-5 sm:px-6 py-2 flex items-center justify-center gap-2 overflow-x-auto whitespace-nowrap bg-surface border-b border-line text-ink text-xs">
