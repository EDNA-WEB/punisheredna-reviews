...
export function IconBook({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M4 5.5C4 4.7 4.7 4 5.5 4H12v16H5.5c-.8 0-1.5-.7-1.5-1.5v-13Z" strokeLinejoin="round" />
...
export function IconStar({ className = 'w-4 h-4', filled = false }: { className?: string; filled?: boolean }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.6">
      <path d="M12 3.5l2.6 5.4 5.9.6-4.4 4.1 1.2 5.9L12 16.8l-5.3 2.7 1.2-5.9-4.4-4.1 5.9-.6L12 3.5Z" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconImage({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M20.5 15l-5-5-9 9" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconEdit({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M13.5 8L16 10.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconHeart({ className = 'w-4 h-4', filled = false }: { className?: string; filled?: boolean }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 20.5s-7.5-4.6-10-9.3C.4 8 1.8 4.5 5.2 3.6c2.1-.5 4.2.3 5.5 2.1l1.3 1.7 1.3-1.7c1.3-1.8 3.4-2.6 5.5-2.1 3.4.9 4.8 4.4 3.2 7.6-2.5 4.7-10 9.3-10 9.3Z" />
    </svg>
  );
}

export function IconThumbUp({ className = 'w-4 h-4', filled = false }: { className?: string; filled?: boolean }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7 11v9H4a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1h3Zm0 0 4.5-7.5A1.8 1.8 0 0 1 13 3a2 2 0 0 1 2 2v4h3.5a2 2 0 0 1 1.95 2.44l-1.4 6A2 2 0 0 1 17.1 19H7" />
    </svg>
  );
}
export function IconThumbDown({ className = 'w-4 h-4', filled = false }: { className?: string; filled?: boolean }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 13V4h3a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-3Zm0 0-4.5 7.5a1.8 1.8 0 0 1-1.5.5 2 2 0 0 1-2-2v-4H5.5a2 2 0 0 1-1.95-2.44l1.4-6A2 2 0 0 1 6.9 5H17" />
    </svg>
  );
}

export function IconReply({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 10 4 14l5 4" />
      <path d="M4 14h10a6 6 0 0 0 6-6V6" />
    </svg>
  );
}

export function IconHeartOutline({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 20.5s-7.5-4.6-10-9.3C.4 8 1.8 4.5 5.2 3.6c2.1-.5 4.2.3 5.5 2.1l1.3 1.7 1.3-1.7c1.3-1.8 3.4-2.6 5.5-2.1 3.4.9 4.8 4.4 3.2 7.6-2.5 4.7-10 9.3-10 9.3Z" />
    </svg>
...
export function IconFacebook({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M15 3h-2a5 5 0 0 0-5 5v3H6v4h2v6h4v-6h3l1-4h-4V8a1 1 0 0 1 1-1h3V3Z" />
    </svg>
  );
}
...
export function IconTiktok({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14 3v11.2a3.3 3.3 0 1 1-2.5-3.2" />
      <path d="M14 3c.3 2.4 2 4.3 4.5 4.6" />
    </svg>
  );
}
...
export function IconTrophy({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M8 21h8" />
      <path d="M12 17v4" />
...
export function IconMic({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
// Ikonka titulkov — obdĺžnik s "CC" (celosvetovo zaužívaný symbol titulkov)
export function IconSubtitles({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="5" width="20" height="14" rx="2.5" />
      <path d="M7 10.5c-.6-.6-1.5-1-2.3-.7-1 .4-1.4 1.5-1.4 2.2s.4 1.8 1.4 2.2c.8.3 1.7-.1 2.3-.7" />
      <path d="M16 10.5c-.6-.6-1.5-1-2.3-.7-1 .4-1.4 1.5-1.4 2.2s.4 1.8 1.4 2.2c.8.3 1.7-.1 2.3-.7" />
    </svg>
  );
}

// Ikonka dabingu — reproduktor so zvukovými vlnami
export function IconDubbing({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
// Ikonka pre film bez titulkov aj bez dabingu (len originálne znenie)
export function IconOriginalOnly({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="9" />
...
export function IconQrcode({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="4" y="4" width="6" height="6" rx="1" />
      <rect x="14" y="4" width="6" height="6" rx="1" />
      <rect x="4" y="14" width="6" height="6" rx="1" />
      <path d="M14 14h3m3 0h.01M14 17v3m3-3v3m3-3v3M17 14v.01" />
    </svg>
  );
}
...
export function IconShoppingCart({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
