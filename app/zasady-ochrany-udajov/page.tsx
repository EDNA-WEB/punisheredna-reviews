...
export default async function PrivacyPolicyPage() {
  ...
  const text = settings?.privacyPolicyText || DEFAULT_PRIVACY_POLICY_TEXT;
  const lines = text.split('\n');

  return (
    <div className="pt-8 max-w-2xl">
      <h1 className="font-display font-extrabold text-3xl text-ink mb-1">Zásady ochrany osobních údajů</h1>
